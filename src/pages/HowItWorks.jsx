  ...
  return (
    <div>
      ...
      <section className="max-w-6xl mx-auto px-5 pb-16 grid md:grid-cols-3 gap-6">
        <div className="md:col-span-2 bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-colors">
          <p className="text-4xl font-extrabold text-white/10 mb-3">01</p>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 flex flex-col justify-center text-center items-center hover:bg-white/10 transition-colors">
          <ShieldCheck size={36} className="text-primary mb-4" />
          <h3 className="font-bold text-white mb-2">Vetted Professionals</h3>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-colors">
          <p className="text-4xl font-extrabold text-white/10 mb-3">02</p>
          ...
          <div className="grid grid-cols-7 gap-1 text-center text-sm mb-4">
            {[12, 13, 14, 15, 16, 17, 18].map((d) => (
              <span
                key={d}
                className={`py-1.5 rounded-lg ${d === 13 ? "bg-primary text-white" : "text-gray-400"}`}
              >
                {d}
              </span>
            ))}
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 flex flex-col hover:bg-white/10 transition-colors">
          <p className="text-4xl font-extrabold text-white/10 mb-3">03</p>
          <h3 className="text-xl font-bold text-white mb-2">Confirm & Relax</h3>
          <p className="text-sm text-gray-400 mb-4">
      ...
      <section className="bg-white/5 border-t border-white/10 py-16">
        <div className="max-w-6xl mx-auto px-5 text-center">
          <h2 className="text-2xl md:text-3xl font-extrabold text-white mb-2">The Servease Quality Guarantee</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-left">
            {guarantees.map((g) => (
              <div key={g.title}>
                <div className="w-10 h-10 rounded-full bg-white/10 text-primary flex items-center justify-center mb-4">
                  <g.icon size={18} />
                </div>
      ...
      <section className="max-w-3xl mx-auto px-5 py-16">
        ...
        <div className="space-y-3">
          {faqs.map((f, i) => (
            <div key={f.q} className="border border-white/10 bg-white/5 rounded-xl overflow-hidden">
              <button
                onClick={() => setOpenIdx(openIdx === i ? null : i)}
                className="w-full flex items-center justify-between px-5 py-4 text-left font-medium text-white hover:bg-white/10 transition-colors"
              >
                {f.q}
                <ChevronDown
                  size={18}
                  className={`text-gray-500 transition-transform ${openIdx === i ? "rotate-180" : ""}`}
                />
              </button>
              {openIdx === i && (
                <div className="px-5 pb-4 text-sm text-gray-400">{f.a}</div>
              )}
            </div>
          ))}
        </div>
      ...
      <section className="max-w-6xl mx-auto px-5 pb-16">
        <div className="bg-gradient-to-br from-[#004c69] to-[#0a0a0a] border border-white/10 rounded-[3rem] px-8 py-14 text-center">
          <h2 className="text-2xl md:text-3xl font-extrabold text-white mb-2">Ready to experience professional ease?</h2>
          <p className="text-gray-300 mb-8">
            Join over 50,000 households who trust Servease for their daily
            home management needs.
          </p>
          <div className="flex justify-center gap-3">
            <button className="bg-primary text-white text-sm font-semibold px-5 py-3 rounded-lg hover:bg-white hover:text-black transition-colors">Download for iOS</button>
            <button className="border border-white/20 text-gray-300 text-sm font-semibold px-5 py-3 rounded-lg hover:bg-white/10 transition-colors">Download for Android</button>
          </div>
        </div>
      </section>
    </div>
